...
export default function PackageDetailsPage() {
  ...
  const pkg = useMemo(() => {
    return allPackagesData.find(p => p.id === Number(id));
  }, [id]);
  ...
  const handleBookNow = () => {
    router.push(`/booking?type=package&id=${id}`);
  };
          ...
          >
            ...
            <div className="flex flex-col gap-2">
               <div className="flex items-baseline gap-2">
                ...
                <span className="text-gray-500 text-lg">/ total package</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Complete coordination and management</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Quality assurance by Jain Vidhi Vidhan</span>
                </li>
              </ul>
            </div>
